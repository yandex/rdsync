...
do
    ...
    do
        ...
        docker exec rdsync_redis${i}_1 cat "${logfile}" > "tests/logs/redis${i}/${logname}"
    done

    docker exec rdsync_zoo${i}_1 cat /var/log/zookeeper/zookeeper.log > tests/logs/zookeeper${i}/zookeeper.log 2>&1
done
